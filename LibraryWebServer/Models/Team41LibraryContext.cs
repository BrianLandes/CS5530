...
{
    public partial class Team41LibraryContext : DbContext
    {
        public Team41LibraryContext()
        {
        }

        public Team41LibraryContext(DbContextOptions<Team41LibraryContext> options)
            : base(options)
        {
        }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
                optionsBuilder.UseMySql("Server=atr.eng.utah.edu;User Id=u0603319;Password=mypasswordisbutts;Database=Team41Library");
            }
        }
